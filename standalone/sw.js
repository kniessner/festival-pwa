...
const SHELL_ASSETS = [
    ...
    './shared/css/views.css',
    './shared/js/app.js',
    './shared/js/config.js',
    './shared/js/store.js',
    './shared/js/favorites.js',
    './shared/js/festival.js',
    './shared/js/ui.js',
    './shared/js/router.js',
    './shared/js/search.js',
    './shared/js/install.js',
    './shared/js/views/home.js',
    './shared/js/views/timetable.js',
    './shared/js/views/info.js',
    './shared/js/views/favorites.js',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-512.png',
    './images/bg.jpg',
